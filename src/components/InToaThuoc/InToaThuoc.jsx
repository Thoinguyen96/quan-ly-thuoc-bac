...
function InToaThuoc({ toaThuoc, danhSachViThuoc, setHamIn }) {
    const noiDungIn = (
        <div className="khu-vuc-in-toa-thuoc">
    ...
    return createPortal(noiDungIn, document.body);
}
